...
#define ETX_OTA_SOF  0x2A    // Start of Frame   '*'    //BARC INSPIRATION
#define ETX_OTA_EOF  0x23    // End of Frame      '#'   //BARC INSPIRATION
...
#define ETX_OTA_MAX_FW_SIZE ( 1024 * 128 )
...
typedef enum
{
  ETX_OTA_PACKET_TYPE_CMD       = 4,    // Command
